...
# For the latest revision, use "main" for SDL3 and "SDL2" for SDL2
...
ARG CMAKE_ARGS=-DCMAKE_INSTALL_PREFIX=/sdl \
...
RUN cd /sdl && tar -czf /utsdl.tgz include/SDL* lib/cmake/SDL* \
    lib/pkgconfig/SDL* lib/pkgconfig/sdl* lib/libSDL* bin/sdl*
